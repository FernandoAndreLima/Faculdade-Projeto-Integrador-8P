...
public class CursoOverviewController {
	 ...
	 */
	public CursoOverviewController() {
	...
	@FXML
	private void handleGerarData() {
		UtilCreteFakeData creteFakeData = new UtilCreteFakeData();
		creteFakeData.createData();
	}
}
