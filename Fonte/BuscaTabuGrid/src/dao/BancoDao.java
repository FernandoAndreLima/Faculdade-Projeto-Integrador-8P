...
public class BancoDao {
	...
	static Set<Professor> professores;
	...
	public static boolean generateData() {
		...
		populaDisciplinas().disciplina1.addProfessor(populaProfessores().professor1);
	...
	private static void populaCurso() {
		//cria os cursos
	...
	private static void populaDisciplinas() {

		
	}
	
	private static void populaProfessores() {
